...
var catalog = map[string]entry{
	"discovered_unsupported": {text: "Discovered SSH target needs explicit connection settings.", doctorFix: "Reconnect with a plain SSH session, or use host add NAME with connection options."},
	"invalid_alias": {
